...
<div class="card shadow mb-4">
   <div class="card-header py-3">
      <div class="row">
       <div class="col-sm-6">
       <a href="<?php echo e(url('nasabah/create')); ?>">tambah nasabah</a>
       </div>
...
<!--<td>  Rp. <?php echo e(number_format( $b->dataSaldo->sum('saldo') /100*6 ,2)); ?></td>-->
<td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $b->created_at)->diffForHumans() .' / '.$b->created_at->format('d-M-Y')); ?></td>
<td>  
  <a href="<?php echo e(url('/nasabah/'.$b->id_enc)); ?>" >identitas</a> | <a href="<?php echo e(url('/saldo/'.$b->id_enc)); ?>" >dana</a> | <a href="<?php echo e(url('/bunga/'.$b->id_enc)); ?>" >rincian bunga</a> 
</td>
</tr>
 ...
 <div id="tambahBunga" class="modal fade" role="dialog">
    <div class="modal-dialog">
       <div class="modal-content">
         <form method="post" action="<?php echo e(url('bunga')); ?>" id="formbunga">
         <?php echo csrf_field(); ?>
         </form>        
...
<?php echo $__env->make('layouts.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koperasi\resources\views/admin/index.blade.php ENDPATH**/ ?>
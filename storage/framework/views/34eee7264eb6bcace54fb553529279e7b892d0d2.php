...
<div class="card-body">
    ...
    <?php echo Form::open(['url' => '/','files' => 'true','enctype'=>'multipart/form-data']); ?>
    ...
    <?php echo Form::text('hp','ll',['id'=>'email', 'value'=>' ','class'=>'form-control form-control-sm','disabled']); ?>
...
<?php echo $__env->make('layouts.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amp\resources\views/admin/tambahidentitas.blade.php ENDPATH**/ ?>
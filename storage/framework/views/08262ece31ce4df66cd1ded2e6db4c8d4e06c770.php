...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(url('admin/produk')); ?>"  aria-expanded="true" aria-controls="collapseTwo">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(url('admin/paket')); ?>">..</a>
            <a class="collapse-item" href="<?php echo e(url('admin/web')); ?>">..</a>
          </div>
        </div>
      </li>
...
<?php /**PATH C:\xampp\htdocs\Amp\resources\views/layouts/appAdmin.blade.php ENDPATH**/ ?>
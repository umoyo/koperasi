...
<tbody>	
@foreach($identitas->dataSaldo()->orderBy('created_at','desc')->get() as $index =>$b)
<tr>
<td class="nomor"> {{$index +1}} </td>
<td>  @if ($b->saldo > "0")  {{number_format( $b->saldo,2)}} @endif</td>
<td> @if ($b->saldo <= "0") {{number_format( $b->saldo,2)}}  @endif </td>
<td>  {{$b->keterangan}}</td>
<td>  {{$b->created_at}}</td>
</tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <input type="hidden" class="form-control" id="id_enc" value="{{$identitas->id_enc}}">
